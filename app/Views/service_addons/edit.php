<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-1">Edit Add-on Pekerjaan</h1>
        <p class="text-muted mb-0">Ubah data pekerjaan tambahan.</p>
    </div>
    <div>
...
<div class="card shadow-sm border-0">
    <div class="card-body">
        <form action="<?= BASE_URL; ?>serviceaddon/update/<?= $addon['id']; ?>" method="POST">
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label">Nama Add-on</label>
                    <input type="text" name="name"
                        class="form-control <?= !empty($errors['name']) ? 'is-invalid' : ''; ?>"
                        value="<?= htmlspecialchars($addon['name']); ?>" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="addon_category" class="form-control"
                        value="<?= htmlspecialchars($addon['addon_category'] ?? ''); ?>">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <select name="vehicle_category"
                        ...
                        <option value="motor" <?= $addon['vehicle_category'] === 'motor' ? 'selected' : ''; ?>>Motor
                        </option>
                        <option value="mobil" <?= $addon['vehicle_category'] === 'mobil' ? 'selected' : ''; ?>>Mobil
                        </option>
                        <option value="umum" <?= $addon['vehicle_category'] === 'umum' ? 'selected' : ''; ?>>Umum</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="price"
                        ...
                        value="<?= (float) $addon['price']; ?>" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="estimated_minutes"
                        ...
                        value="<?= (int) $addon['estimated_minutes']; ?>" required>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" rows="4"
                        class="form-control"><?= htmlspecialchars($addon['description'] ?? ''); ?></textarea>
                </div>
            </div>
